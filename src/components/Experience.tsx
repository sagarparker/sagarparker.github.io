  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description: [
        ...
        'Led R&D for Twitter Agent Service, an AI-powered solution built in Python & BrowserUse that securely manages Twitter API credentials within a TEE, enabling verifiable tweets while preserving confidentiality.',
    ...
    },
    {
      ...
      description: [
        ...
        'Significantly contributed to the research and development of Marlin Oyster a TEE system based on AWS nitro enclaves which allow computations to happen verifiably and securely.',
